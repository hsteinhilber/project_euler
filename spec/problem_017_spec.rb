...
describe Problem017 do
  ...
  describe "converting numbers to words" do
    ...
    it "converts 19 to 'ninteen'" do
      19.to_words.should == 'ninteen'
    end
    ...
    it "converts 300 to 'three hundred'"

    it "converts 103 to 'one hundred and three'"

    it "converts 1000 to 'one thousand'"

    it "converts 342 to 'three hundred and forty-two'"

    it "converts 115 to 'one hundred and fifteen'"
  end

  describe "computing total letters" do

    it "counts the letters in 'one' as 3"

    it "counts the letters in 'twenty-one' as 9"

    it "counts the letters in 'one hundred and twenty-one' as 22"

    it "computes 3 letters for numbers up to 1 ('one')"
    
    it "computes 11 letters for numbers up to 3 ('one'+'two'+'three')"

    it "computes 19 letters for numbers up to 5 ('one'+'two'+'three'+'four'+'five')"
  end

  it "computes the total letters for all numbers up to 1,000"
end
